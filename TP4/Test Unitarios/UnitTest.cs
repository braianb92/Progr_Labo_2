...
namespace Test_Unitarios
{
    ...
    public class UnitTest
    {
        ...
        //NO REQUERIDO POR TP4 - TESTEO PERSONAL
        [TestMethod]
        public void Serializador_Guardar()
        {
            Paquete paquete = new Paquete("Bs As", "20/001");

            Assert.IsTrue(SerializadorXml<Paquete>.GuardarXml("testXML.xml", (Paquete)paquete));
        }

        //NO REQUERIDO POR TP4 - TESTEO PERSONAL
        [TestMethod]
        public void Serializador_Leer()
        {
            Paquete paquete = new Paquete();
            Assert.IsTrue(SerializadorXml<Paquete>.LeerXml("testXML.xml", out paquete));
            Assert.IsTrue(SerializadorXml<Paquete>.GuardarXml("testXML_Leido.xml", (Paquete)paquete));
        }
        #endregion
